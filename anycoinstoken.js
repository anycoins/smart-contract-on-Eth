...
contract('anycoins', function(accounts) {
  it("Create 300 000 tokens at the owner account", function(done) {
    anycoins.deployed().then(function(instance) {
      return instance.balanceOf.call(accounts[0]);
    }).then(function(balance) {
      assert.equal(web3.toWei(balance.valueOf(), 'ether'), web3.toWei(300000, 'ether'), "300000 wasn't in the first account");
    });
    done();
  });
